package com.hanming.xiao.book.reflect1;
...
public class ReflectExample {
    ...
    public static ReflectExample getInstance() throws Exception{
        return (ReflectExample) Class.forName("com.hanming.xiao.book.reflect1.ReflectExample").newInstance();
    }
    ...
    public static ReflectExample getInstance(String name) throws Exception{
        return (ReflectExample) Class.forName("com.hanming.xiao.book.reflect1.ReflectExample").
